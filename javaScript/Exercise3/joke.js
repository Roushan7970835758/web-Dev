let temp = [
    ...
    Thunderwear`,
    `   Two pickles fell out of a jar onto the floo   What did one say to the other? 
    Dill with it`,
...
Snow`,
 ...
 it was a pound cake`,
    ...
    A blood hound`,
    `   What is a ghosts nose full of? 
    Boo-gers`,
    `   What do birds say on Halloween? 
    Trick or tweet`,
    `   Are black cats bad luck? 
    Sure, if youre a mouse`,
 ...
 it was stuck on the turkey's foot`,
    ...
    `   Whats the best thing to put into pumpkin pie? 
    Your teeth`,
    `   Whats the best dance to do on Thanksgiving? 
    The turkey trot`,
 ...
 it needed to be trimmed`,
    `   What is an elfs favorite kind of music? 
    Wrap music`,
    ...
    A pine-apple`,
    `   In what year does New Years Day come before Christmas? 
    Every year`,
    ...
    `   What do you call a bunny who isnt smart? 
    A hare brain`,
 ...
 it might crack up`,
    ...
    Only one because after that, its not empty`,
...
let joke_picker = Math.floor(Math.random() * temp.length)

const myElement = document.getElementById('id1')
let originalString = temp[joke_picker];
let splited_array = originalString.split('?')

document.write(`<div>${splited_array[0]} <br> ${splited_array[1]}</div>`)
